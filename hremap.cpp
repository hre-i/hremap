...
#define NO_CHG (-1)
    ...
    { KEY_W,     KEY_W,         BIT_RIGHTMETA, false },
    { KEY_E,     KEY_E,         BIT_RIGHTMETA, false },
    { KEY_R,     KEY_R,         BIT_RIGHTMETA, false },
    { KEY_T,     KEY_T,         BIT_RIGHTMETA, false },
...
//  { KEY_P,                                         },
    ...
    { KEY_A,     KEY_A,         BIT_RIGHTMETA, false },
    { KEY_S,     KEY_S,         BIT_RIGHTMETA, false },
    { KEY_D,     KEY_D,         BIT_RIGHTMETA, false },
    { KEY_F,     KEY_F,         BIT_RIGHTMETA, false },
    { KEY_G,     KEY_G,         BIT_RIGHTMETA, false },
